...
public class InitStuff {
    public static void init() {
        ...
        PluginEvents.RunnableEventType.RELOAD.register(() -> {
            ...
            Julti.log(Level.INFO, "Better Reset Plugin Reloaded!");
        });
        ...
        PluginEvents.RunnableEventType.STOP.register(() -> {
            ...
            Julti.log(Level.INFO, "Better Reset Plugin shutting down...");
        });

        PluginEvents.InstanceEventType.RESET.register(instance -> {
            ResetSound.playSound(options.singleResetSound, options.lockVolume);
        });
    }
}
